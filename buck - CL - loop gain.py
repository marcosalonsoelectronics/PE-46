...
mag, phase, omega = bode_plot(T, dB=True, Hz=True, omega_limits=(10,1000e3),\
                              omega_num=100, color="blue" )
# Print phase margin and crossover frequency
...
i=80; print(omega[i]/2/pi, 20*log10(mag[i]), phase[i]*180/pi)
